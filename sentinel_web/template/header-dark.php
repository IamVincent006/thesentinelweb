...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.5.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-MmUjv89qE8/9e/9gReKcG7F/T4Wvz7Fi87lwKFyj1A6L6tx5S4x8Z0U7q/yoDnb" crossorigin="anonymous"></script>
...
<div class="hdr-frame">
	...
	<div class="hdr-wrapper">
		<div class="menu-button__hldr">
			...
			<div class="menu-text" >
				<p style="color: #162747;">Menu</p>
			</div>
		</div>
		<div class="hdr-right__hldr">
			<div class="hdr-right__link" >
				<a href="request-appointment.php" style="color: #162747;">REQUEST APPOINTMENT</a>
			</div>
		</div>
	</div>
...
<div class="menu-hldr">
	...
	<div class="menu-hldr__wrapper">
        ...
        <div class="menu-container">
            ...
            <div class="menu-link">
                <a class="text" data-text="Permits & Licenses" href="permits.php">Permits & Licenses</a>
            </div>
            <div class="menu-link link">
