            ...
            <div class="col-md-6">
                ...
                <form action = "" method = "post" class="d-flex flex-column p-4" style="width: 750px; height: 750px;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control input-sm" name="area_code" value="<?=$query["area_code"]?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="area_name" value="<?=$query["area_name"]?>">
                        <small id="emailHelp" class="form-text text-muted"></small>
                    </div>
                    <div class="form-group">
                        <label for="payment_gracehour">Payment GraceHour:</label>
                        <input type="text" class="form-control" name="payment_gracehour" value="<?=$query["payment_gracehour"]?>">
                        <small id="emailHelp" class="form-text text-muted"></small>
                    </div>
                    <div class="form-group">
                        <label for="payment_graceminute">Payment GraceMinutes</label>
                        <input type="text" class="form-control" name="payment_graceminute" value="<?=$query["payment_graceminute"]?>">
                        <small id="emailHelp" class="form-text text-muted"></small>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="entry_gracehour" value="<?=$query["entry_gracehour"]?>">
                        <small id="emailHelp" class="form-text text-muted"></small>
                    </div>
                    <div class="form-group">
                        <label for="entry_graceminute">Entry GraceMinutes</label>
                        <input type="text" class="form-control" name="entry_graceminute" value="<?=$query["entry_graceminute"]?>">
                        <small id="emailHelp" class="form-text text-muted"></small>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="cutoffhour" value="<?=$query["cutoffhour"]?>">
                        <small id="emailHelp" class="form-text text-muted"></small>
                    </div>
                    <div class="form-group">
                        <label for="cutoffminute">Cutoff Minutes</label>
                        <input type="text" class="form-control" name="cutoffminute" value="<?=$query["cutoffminute"]?>">
                        <small id="emailHelp" class="form-text text-muted"></small>
