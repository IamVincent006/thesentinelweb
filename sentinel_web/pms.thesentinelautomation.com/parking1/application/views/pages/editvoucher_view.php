            ...
            <div class="col-md-6">
                ...
                <form action = "" method = "post" class="d-flex flex-column p-4" style="width: 750px; height: 750px;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control input-sm" name="dc_name" value="<?=$query["dc_name"]?>">
                   ...
                   <div class="form-group">
                        ...
                        <?php foreach ($rates as $value):?>
                            ...
                            <option value = "<?= $value["rate_id"] ?>" 
                             <?= $value["rate_id"]==$query['dc_amount'] ? 'selected="selected"' : '' ?>><?= $value["rate_code"] ?></option>
                    ...
                    <div class="form-group">
                        ...
                        <span style="color: red;">*</span>
                        <input type="text" class="form-control input-sm" name="dc_desc" value="<?=$query["dc_desc"]?>">
                        <small id="emailHelp" class="form-text text-muted"></small>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Code:</label>
                        <span style="color: red;">*</span>
                        <input type="text" class="form-control input-sm" name="dccode" value="<?=$query["dccode"]?>" readonly>
                        <small id="emailHelp" class="form-text text-muted"></small>
                    </div>
