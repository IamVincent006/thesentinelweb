            ...
            <div class="col-md-6">
                ...
                <form action = "" method = "post" class="d-flex flex-column p-4" style="width: 750px; height: 750px;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="firstname" value="<?=$query["firstname"]?>">
                        <small id="emailHelp" class="form-text text-muted"></small>
                    </div>
                    <div class="form-group">
                        <label for="initcharge">Last Name:</label>
                        <input type="text" class="form-control" name="lastname" value="<?=$query["lastname"]?>">
                        <small id="emailHelp" class="form-text text-muted"></small>
                    </div>
                    <div class="form-group">
                        ...
                        <?php foreach ($userlevel as $value):?>
                            ...
                            <option value = "<?= $value["userlevel_id"] ?>" <?= $query["userlevel"]==$value["userlevel_id"] ? 'selected="selected"' : '' ?>> <?= $value["userlevel_name"] ?></option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control input-sm" name="username" value="<?=$query["username"]?>" readonly="readonly">
                        <small id="emailHelp" class="form-text text-muted"></small>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" name="confirmpword">
                        <small id="emailHelp" class="form-text text-muted"></small>
                    </div>

                    <div class="form-group">
                        <label for="oncharge">User Status</label>
                        <select name = "userstatus" class="form-control">

                        <option value = "" style="background-color:#007bff; color: white;" disabled><strong>USER STATUS</strong></option>

                            <option value = "0" <?= $query["status"]== 0 ? 'selected="selected"' : '' ?>> INACTIVE </option>
                            <option value = "1" <?= $query["status"]== 1 ? 'selected="selected"' : '' ?>> ACTIVE </option>
