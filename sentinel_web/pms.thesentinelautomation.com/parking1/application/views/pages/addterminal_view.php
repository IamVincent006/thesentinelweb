            ...
            <div class="col-md-6">
                ...
                <form action = "" method = "post" class="d-flex flex-column p-4" style="width: 750px; height: 750px;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="termname" value="<?= $termname ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="termIP" value="<?= $termIP ?>">
                        <small id="emailHelp" class="form-text text-muted"></small>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="area_code" value="<?= $area_code ?>">
                        <small id="emailHelp" class="form-text text-muted"></small>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="docnum" value="<?= $docnum ?>">
                        <small id="emailHelp" class="form-text text-muted"></small>
                    </div>
                    <div class="form-group">
                        ...
                        <option value = "ENTRY"  <?= "ENTRY"==$termtype ? 'selected="selected"' : '' ?>>ENTRY</option>
                        <option value = "EXIT"  <?= "EXIT"==$termtype ? 'selected="selected"' : '' ?>>EXIT</option>
                        <option value = "PAYMENT"  <?= "PAYMENT"==$termtype ? 'selected="selected"' : '' ?>>PAYMENT</option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control input-sm" name="termcnt" value="<?= $termcnt ?>">
                        <small id="emailHelp" class="form-text text-muted"></small>
                    </div>
                    <div class="form-group">
                        <label for="surcharge_hour">RECEIPT</label>
                        <input type="text" class="form-control" name="termreceipt" value="1" readonly="readonly">
                        <small id="emailHelp" class="form-text text-muted"></small>
                    </div>
                    <div class="form-group">
                        <label for="surcharge_hour">TELLER</label>
                        <input type="text" class="form-control" name="termtellerlogID" value="1" readonly="readonly">
                        <small id="emailHelp" class="form-text text-muted"></small>
                    </div>
                    <div class="form-group">
                        <label for="surcharge_hour">PARKER</label>
                        <input type="text" class="form-control" name="termparkid" value="1" readonly="readonly">
                        <small id="emailHelp" class="form-text text-muted"></small>
                    </div>
