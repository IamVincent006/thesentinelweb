            ...
            <div class="col-md-6">
                ...
                <form action = "" method = "post" class="d-flex flex-column p-4" style="width: 500px; height: 750px;">
                    ...
                    <div class="form-group">
                        ...
                        <!--<input type="text" class="form-control" name="cardserial" id="cardserial"  value="<?= $cardserial ?>"readonly="readonly">-->
                        <input type="text" class="form-control" name="cardserial" id="cardserial"  value="<?= $cardserial ?>">
                    </div>
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control input-sm" name="platenum" value="<?= $platenum ?>">
                        
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">First Name:</label>
                        <input type="text" class="form-control input-sm" name="firstname" value="<?= $firstname ?>">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Last Name:</label>
                        <input type="text" class="form-control input-sm" name="lastname" value="<?= $lastname ?>">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Valid Until:</label>
                        <input type="text" class="form-control input-sm" name="cardvalidity" id="cardvalidity"  autocomplete="off" class="form-control" placeholder="Input date.." value="<?= $cardvalidity ?>">
...
$( function() {
  ...
  var interval = 1200;  // 1000 = 1 second, 3000 = 3 seconds
    function doAjax() {
         $.ajax({
                type: 'POST',
                url: "<?php echo base_url('/acsreader/getserial'); ?>",
                data: $(this).serialize(),
                dataType: 'JSON',
