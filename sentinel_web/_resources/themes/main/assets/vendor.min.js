	...
	init: function () {
		...
		switch (pageID) {
			...
			case 'RequestAppointment':
				setup.requestappointment();
				break;
			case 'RequestQuotation':
				setup.requestquotation();
				break;
			case 'ContactUsPage':
				setup.contactuspage();
				break;
	...
	setup: {
		...
		menu: function () {
			...
			$('.menu-btn').click(function () {
				$('.menu-hldr').fadeIn();
				tl.staggerFromTo(".menu-link", .2, { y: 5, opacity: 0 }, { y: 0, opacity: 1 }, 0.2);
			});

			$('.menu-close').click(function () {
				// $('.menu-hldr').hide();
				tl.staggerFromTo(".menu-link", .2, { y: 0, opacity: 1 }, { y: -10, opacity: 0 }, 0.2);
				$('.menu-hldr').delay(1300).fadeOut().addClass('reset');
			});
			...
			//app.form.init($('#mcontactForm'), $('#mcontactBtn'), 'form/contact/send', false);
      app.form.init($('#contactForm'), $('#contactBtn'), 'mailsubmit.php', false);
      app.form.init($('#mcontactForm'), $('#mcontactBtn'), 'mailsubmit.php', false);
		},

		homepage: function () {

			$('.preload').delay(4000).fadeOut();

			// $('.preload .background').delay(1000).fadeOut();
			// $('.preload img').delay(3000).addClass('animate-init');

			var controller = new ScrollMagic.Controller();

			new ScrollMagic.Scene({ triggerElement: ".vid" }).setClassToggle(".hdr-frame.white", "scroll").addTo(controller);

			$('.scrollbar-content').scroll(function () {
				var scroll = $('.scrollbar-content').scrollTop();
				//>=, not <=
				if (scroll >= 100) {
					//clearHeader, not clearheader - caps H
					$(".hdr-frame.white").addClass("scroll");
				} else {
					$(".hdr-frame.white").removeClass("scroll");
				}
			}); //missing );

			$(".vid").lightGallery({
				selector: '.hm-frame1__vid'
			});
			...
			$('.slider-content').removeClass('slick-current');

			new ScrollMagic.Scene({ triggerElement: ".hm-frame3" }).setClassToggle('.slider-content.slick-active', "slick-current").addTo(controller);

			$('.hm-frame3__slider').on('beforeChange', function (event, slick, currentSlide, nextSlide) {
				$('.slider-content').removeClass('slick-current');
			}).trigger('afterChange');

			$('.hm-frame3__slider').on('afterChange', function (event, slick, currentSlide, nextSlide) {
				$('.slider-content.slick-active').addClass('slick-current');
			}).trigger('afterChange');
			...
			$('.brand-slider').slick({
				...
				autoplaySpeed: 2000,
				speed: 1000,
				prevArrow: '.hm-frame4 .left-arrow',
				nextArrow: '.hm-frame4 .right-arrow',
				responsive: [{
					breakpoint: 1024,
					settings: {
						slidesToShow: 1
			...
			// $('.hm-frame6 .project-holder').slick({
			// 	infinite: true,
			// 	slidesToShow: 3,
			// 	slidesToScroll: 1,
			// 	autoplay: false,
		...
		aboutpage: function () {
			...
			$('.testimonial-slider').slick({
				...
				speed: 500,
				// fade: true,
				prevArrow: '.abt-frame4 .left-arrow',
				nextArrow: '.abt-frame4 .right-arrow'
			});
		},
		...
		careerpage: function () {
			...
			$(".career-card").click(function () {
				$(".career-card").removeClass("open");
				$(".career-card__holder").css("height", "170px");
				$(".career-card__wrapper").css("height", "auto");
				let cardid = $(this).data("id");
				let wrapper = $("#wrapper-" + cardid);
				let cardholder = $("#cardholder-" + cardid);
				$(this).addClass('open');
				let careerheight = cardholder.height();
				wrapper.css("height", careerheight);
				let height = cardholder.css("height", "auto").height();
		...
		productpage: function () {
			...
			$('.pdct-frame1__tab-container').slick({
				infinite: false,
				slidesToShow: 2,
				slidesToScroll: 1,
				autoplay: false,
			...
			$('#btnfilter').click(function () {
				// var myDropDown = $('#select-filter');
				// var length = $('#select-filter> option').length;
				// //open dropdown
			...
			$('#select-filter').on('change', function () {
				$('.pdct-frame1__product-wrapper').hide();
				$('#' + this.value).fadeIn();
			});
			...
			$('.pdct-frame1__product-wrapper').hide();
			$('.pdct-frame1__product-wrapper:first-child').show();
		...
		productcategory: function () {
			...
			$('.pdct-frame1__tab').removeClass("slick-active");

			$('.current').addClass('slick-active');
		...
		requestappointment: function () {
			$('.hdr-frame.white').addClass('scroll');
			app.form.init($('#appointmentForm'), $('#appointmentBtn'), 'form/appointment/send', false);

			$('.frm-input').each(function () {
				var id = $(this).data('id');

				$(this).fileupload({
					url: baseHref + 'form/appointment/upload',
					dataType: 'json',
		...
		requestquotation: function () {
			$('.hdr-frame.white').addClass('scroll');
			app.form.init($('#quotationForm'), $('#quotationBtn'), 'mailproduct.php', false);
		},
		...
		contactuspage: function () {
			...
			$('.map-slider').slick({
				...
				speed: 500,
				fade: true,
				prevArrow: '.cnt-frame1 .left-arrow',
				nextArrow: '.cnt-frame1 .right-arrow'
			}).slickAnimation();

			app.form.init($('#newsletterForm'), $('#newsletterBtn'), 'form/newsletter/send', false);
		},
		search: function () {
			$('.hdr-frame.white').addClass('scroll');
		}
